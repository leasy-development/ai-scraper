  ...
  return (
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-foreground">Loading Components</h1>
          <p className="text-muted-foreground">
            Comprehensive loading states and components for the AiScraper application
          </p>
        </div>
        ...
        <Card className="glass border-border/50">
          ...
          <CardContent>
            <LoadingWrapper 
              ...
              overlay={true}
              fallback={<Loading variant="brand" size="lg" text="Processing data..." />}
            >
              <div className="p-8 text-center">
                <h3 className="text-lg font-semibold mb-2">Content Area</h3>
                <p className="text-muted-foreground">
                  This content will be overlaid with a loading spinner when the async operation is running.
                </p>
          ...
          <CardContent>
            <div className="space-y-4 text-sm">
              <div>
                ...
                <span className="text-muted-foreground ml-2">Full-screen loading for initial app load or page transitions</span>
              </div>
              <div>
                <strong className="text-foreground">CardLoading:</strong>
                <span className="text-muted-foreground ml-2">Loading state within cards or contained areas</span>
              </div>
              <div>
                <strong className="text-foreground">ButtonLoading:</strong>
                <span className="text-muted-foreground ml-2">Inline loading for buttons during form submission</span>
              </div>
              <div>
                <strong className="text-foreground">TableLoading:</strong>
                <span className="text-muted-foreground ml-2">Loading state for data tables and lists</span>
              </div>
              <div>
                <strong className="text-foreground">SkeletonCard/Table:</strong>
                <span className="text-muted-foreground ml-2">Content placeholders during initial data fetch</span>
              </div>
              <div>
                <strong className="text-foreground">LoadingWrapper:</strong>
                <span className="text-muted-foreground ml-2">Conditional loading with optional overlay</span>
              </div>
            </div>
          </CardContent>
        </Card>
